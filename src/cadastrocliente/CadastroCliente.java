...
public CadastroCliente() {
    ...
    L0.setFont(new Font("Dimitri",Font.ITALIC+Font.BOLD,
    30));
    ...
    p1.add(L1); p1.add(tfCPF); p1.add(L2);
    p1.add(tfNome);p1.add(L11); p1.add(L3);p1.add(tfSobrenome);
    p1.add(L4); p1.add(tfCEP);p1.add(L12);p1.add(L5);
    p1.add(tfTelefone);
    p1.add(L7);
    p1.add(L8);
    p1.add(L14);p1.add(b1); p1.add(b2); p1.add(b3); p1.add(b4);
...
int telefone =
Integer.parseInt(this.tfTelefone.getText());

Cliente i = new
Cliente(CPF,nome,sobrenome,CEP,telefone);
if (rep.inserir(i)) {
